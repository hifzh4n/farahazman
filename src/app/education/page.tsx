          ...
          {education.map((item, idx) => (
            ...
            >
              ...
              <div className={`md:w-[calc(50%-3rem)] ${idx % 2 === 0 ? "md:mr-auto" : "md:ml-auto"}`}>
                <div className="bg-card p-7 md:p-8 rounded-[2rem] shadow-lg shadow-foreground/5 ring-1 ring-primary/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
